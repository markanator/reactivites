...
const ActivityListItem = ({ activity }: Props) => {
	...
	return (
		<Box key={id} rounded={"lg"} bg={useColorModeValue("white", "gray.700")} boxShadow={"lg"}>
			{/* USER INFO */}
			<Flex p={4} pb={3} w="full" justifyContent="space-between" alignItems="center">
				<HStack pos="relative">
					<Avatar name={activity?.hostUsername} src={activity.host?.image ?? "/assets/user.png"} />
			...
			{/* IMAGE */}
			<Image src={`/assets/categoryImages/${category}.jpg`} h={325} w="full" objectFit="cover" />
